...
<h1 align="center" style="margin: 30px 0 30px; font-weight: bold;">Image-Annotation</h1>
<h4 align="center">Image-Annotation 项目</h4>
<p align="center">
    <a href="REPLACE_WITH_YOUR_REPO_URL">
        <img alt="Gitee" src="REPLACE_WITH_YOUR_REPO_URL">
    </a>
    <a href="REPLACE_WITH_YOUR_REPO_URL">
        <img alt="Github" src="REPLACE_WITH_YOUR_REPO_URL">
    </a>
    <a href="REPLACE_WITH_YOUR_REPO_URL">
        <img alt="Playwright Tests" src="REPLACE_WITH_YOUR_REPO_URL">
    </a>
    <a href="REPLACE_WITH_YOUR_REPO_URL">
        <img alt="Ruff Check" src="REPLACE_WITH_YOUR_REPO_URL">
    </a>
    <a href="REPLACE_WITH_YOUR_REPO_URL">
...
Image-Annotation 是一套全部开源的快速开发平台，毫无保留给个人及企业免费使用。
...
* *账号：admin*
* *密码：admin123*
* 演示地址：<a href="https://vfadmin.insistence.tech">Image-Annotation</a>
...
移动端详细文档请参考：[Image-Annotation-app/README.md](./Image-Annotation-app/README.md)
